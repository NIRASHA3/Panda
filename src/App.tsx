...
const MOBILE_WIDTH = 414; // Your exact design width
...
function App() {
  ...
  useEffect(() => {
    // Prevent overall window scrolling to keep the centered view pristine
    ...
    const updateScales = () => {
      if (globalThis.window !== undefined) {
        ...
        // --- DESKTOP SCALING (The Perfect Fit) ---
        // Checks both width and height to find the limiting factor.
        // This ensures the 1920x1080 canvas never cuts off on any screen.
  ...
  // ==========================================
  // DESKTOP STYLES (Flexbox Centering)
  // ==========================================
  const desktopOuterWrapStyle: CSSProperties = {
    ...
    overflow: 'hidden', 
    backgroundColor: '#ffffff' // Matches your comic theme to blend empty space natively
  };
  ...
  const desktopInnerWrapStyle: CSSProperties = {
    ...
    transformOrigin: 'center center', // Scales from the dead center outward
    flexShrink: 0, // Prevents flexbox from accidentally squishing the canvas
  };
  ...
  return (
    <div className="panda-page" style={{ width: '100%', overflowX: 'hidden' }}>
      {/* ========================================
          DESKTOP VIEW (Perfectly Centered Screen Fit)
      ======================================== */}
              ...
              <section className="join-box" aria-label="Join community section">
                ...
                <div className="join-panel-wrapper">
                  <div className="join-panel">
                    ...
                    {/* Z-Index added here to prevent image overlap bugs */}
      ...
      {/* ========================================
          MOBILE VIEW (Dynamically Scaled & Centered)
      ======================================== */}
            ...
            <header className="mobile-header" aria-label="Mobile navigation" style={{ position: 'relative', zIndex: 1000 }}>
              ...
              >
                <img 
                  ...
                  style={{ width: '33px', height: '22px', objectFit: 'contain' }}
                />
              </button>
                ...
                <div className="mobile-community-wrapper">
                  <div className="mobile-community-frame">
                    <div className="mobile-community-panel">
                      ...
                      {/* Z-Index added here to prevent image overlap bugs on Mobile */}
